...
@admin_challenges.route('/admin/mychals', methods=['GET'], defaults={'page': '1'})
@admin_challenges.route('/admin/mychals/<int:page>', methods=['GET'])
@admins_only
def admin_mychals(page):
    page = abs(int(page))
    results_per_page = 10
...
@admin_challenges.route('/admin/chals', defaults={'page': '1'})
@admin_challenges.route('/admin/chals/<int:page>', methods=['GET','POST'])
@admins_only
...
@admin_challenges.route('/admin/chal/update/<page>', methods=['POST'])
@admins_only
def admin_update_chal(page):
    challenge = Challenges.query.filter_by(id=request.form['id']).first_or_404()
    chal_class = get_chal_class(challenge.type)
    chal_class.update(challenge, request)
    return redirect(url_for('admin_challenges.admin_mychals',page=page))
